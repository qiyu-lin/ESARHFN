            ...
            for idx_data, d in enumerate(self.loader_test):
                for idx_scale, scale in enumerate(self.scale):
                    ...
                    SSIM_values.append(eval_acc_ssim / len(d))
                        ...
                        #xlsx_file_name = '/home/user1/JWL/RCAN-PyTorch-master/experiment' + self.args.save + '/results-' + d.dataset.name + '/' + d.dataset.name + '.xlsx'
                    #else:
                        #xlsx_file_name = '/home/user1/JWL/RCAN-PyTorch-master/experiment' + self.args.load + '/results-' + d.dataset.name + '/' + d.dataset.name + '.xlsx'
